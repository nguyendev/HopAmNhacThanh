...
{
    public class LoiBaiHatBizLyric
    {
        public static bool Check(HtmlDocument doc)///div
        {
            var nodeP = doc.DocumentNode.SelectSingleNode(".//*[@id='play-lyric']/div[2]");
            if (nodeP == null)
                return false;
        ...
        public static NhanDienLyricViewModel GetContent(HtmlDocument doc, string url)
        {
            ...
            var nodeLyric = doc.DocumentNode.SelectSingleNode(".//*[@id='play-lyric']/div[2]");
