...
{
    public class TaiNhacMp3Lyric
    {
        public static bool Check(HtmlDocument doc)///div
        {
            var nodeP = doc.DocumentNode.SelectSingleNode(".//*[@id='conLyrics']");
            if (nodeP == null)
                return false;
        ...
        public static NhanDienLyricViewModel GetContent(HtmlDocument doc, string url)
        {
            ...
            var nodeLyric = doc.DocumentNode.SelectSingleNode(".//[@id='conLyrics']");
            lyrics = nodeLyric.InnerText;

            return new NhanDienLyricViewModel(url, lyrics, "tAINHACMP3");
        }
    }
}