...
{
    public class HopAmChuan
    {
        public static bool Check(HtmlDocument doc)///div
        {
            var nodeP = doc.DocumentNode.SelectSingleNode(".//*[@id='song-lyric']/div");
            if (nodeP == null)
                return false;
        ...
        public static NhanDienLyricViewModel GetContent(HtmlDocument doc, string url)
        {
            ...
            var nodeLyric = doc.DocumentNode.SelectSingleNode(".//*[@id='song-lyric']/div");
            lyrics = nodeLyric.InnerText;

            return new NhanDienLyricViewModel(url, lyrics, "HopAmChuan");
        }
    }
}
